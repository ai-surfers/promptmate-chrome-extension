...
export default function VOCModal({ isOpen, closeModal }: VOCModalProps) {
	...
	return (
		<Modal
			...
			footer={<></>}
		>
			<Form form={form} name="voc" onFinish={handleOnFinish} layout="vertical">
				<FeedBackDescription>
					추가되었으면 하는 기능이나 불편한 점이 있다면 자유롭게 말해주세요!
					<br />
				...
				<Form.Item name="content" hasFeedback rules={[{ required: true }]}>
					<TextArea placeholder="여기에 의견을 작성해주세요" style={{ minHeight: '80px' }} />
				</Form.Item>
