...
export default function InputTags({ tags, onInsert, onRemove }: InputTagsProps) {
	...
	return (
		<Card
			...
			type="inner"
			extra={
				<Tooltip placement="left" title="사용자 인풋 필드를 추가할 수 있어요">
					<InfoCircleOutlined />
				</Tooltip>
			}
		>
			<TagsContainer>
				...
				{inputVisible ? (
					...
					<Tag style={plusStyle} icon={<PlusOutlined />} onClick={showInput}>
						입력 값 추가
					</Tag>
				)}
			</TagsContainer>
