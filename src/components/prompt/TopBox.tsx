...
export default function TopBox({ isFavorite, id, author, onInformationClick }: TopBoxProps) {
...
export const InfoButton = ({ onInformationClick }: InfoButtonProps) => {
	return (
		<Tooltip title="자세히 보기">
			<Button shape="circle" icon={<InfoOutlined />} onClick={onInformationClick} />
		</Tooltip>
	);
};
...
export const ModifyButton = ({ id }: ModifyButtonProps) => {
	...
	return (
		<Tooltip title="수정하기">
			<Button shape="circle" icon={<EditOutlined />} onClick={handleOnModify} />
		</Tooltip>
	);
};
...
export const DeleteButton = ({ id }: { id: string }) => {
	...
	return (
		<Tooltip title="삭제하기">
			<Button shape="circle" icon={<DeleteOutlined />} onClick={() => setIsModalOpen(true)} />
